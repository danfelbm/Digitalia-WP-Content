      ...
      <div class="grid gap-12">
        <div>
          ...
          <p class="mt-3 text-gray-600">
            Digital-IA surge como respuesta a los desafíos de la comunicación digital y sus efectos en la preservación de los derechos humanos, la estabilidad institucional y la diversidad cultural.
          </p>
        </div>
        ...
        <div class="space-y-6 lg:space-y-10">
          ...
          <div class="flex gap-x-5 sm:gap-x-8">
            <svg class="shrink-0 mt-2 size-6 text-gray-800" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"></path><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"></path></svg>
            <div class="grow">
              <h3 class="text-base sm:text-lg font-semibold text-gray-800">
                Educomunicación para la Paz
              </h3>
              <p class="mt-1 text-gray-600">
                Creemos en el poder de la educomunicación para construir una sociedad más informada y crítica, capaz de navegar el complejo panorama mediático actual.
              </p>
            </div>
          </div>
          <!-- End Icon Block -->
          ...
          <div class="flex gap-x-5 sm:gap-x-8">
            ...
            <div class="grow">
              ...
              <p class="mt-1 text-gray-600">
                Nuestro programa está diseñado para empoderar a todos los ciudadanos, independientemente de su nivel de experiencia tecnológica.
              </p>
            </div>
          </div>
          <!-- End Icon Block -->
          ...
          <div class="flex gap-x-5 sm:gap-x-8">
            ...
            <div class="grow">
              ...
              <p class="mt-1 text-gray-600">
                La alfabetización mediática e informacional es crucial en la era digital actual, donde las tecnologías emergentes impactan significativamente la formación de opinión pública.
              </p>
            </div>
          </div>
          <!-- End Icon Block -->
    ...
    <div>
      <div class="grid gap-12">
        <div>
          ...
          <p class="mt-3 text-gray-600">
            Digital-IA es un programa integral que combina la educación mediática con un enfoque en la construcción de paz, trabajando en colaboración con el Ministerio de Tecnologías de Información y Comunicación.
          </p>
        </div>
        ...
        <div class="space-y-6 lg:space-y-10">
          ...
          <div class="flex gap-x-5 sm:gap-x-8">
            ...
            <div class="grow">
              ...
              <p class="mt-1 text-gray-600">
                Garantizamos que nuestros programas lleguen a todas las comunidades, especialmente a las poblaciones diferenciadas, promoviendo la inclusión digital.
              </p>
            </div>
          </div>
          <!-- End Icon Block -->
          ...
          <!-- Icon Block -->
          <div class="flex gap-x-5 sm:gap-x-8">
            <svg class="shrink-0 mt-2 size-6 text-gray-800" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21.21 15.89A10 10 0 1 1 8 2.83"></path><path d="M22 12A10 10 0 0 0 12 2v10z"></path></svg>
            <div class="grow">
              <h3 class="text-base sm:text-lg font-semibold text-gray-800">
                Transformación Digital
              </h3>
              <p class="mt-1 text-gray-600">
                Nuestro equipo está comprometido con la transformación digital del país y la promoción de una cultura de paz a través de la alfabetización mediática.
              </p>
            </div>
          </div>
          <!-- End Icon Block -->
          ...
          <!-- Icon Block -->
          <div class="flex gap-x-5 sm:gap-x-8">
            <svg class="shrink-0 mt-2 size-6 text-gray-800" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"></path><path d="M13.73 21a2 2 0 0 1-3.46 0"></path></svg>
            <div class="grow">
              <h3 class="text-base sm:text-lg font-semibold text-gray-800">
                Competencias TIC
              </h3>
              <p class="mt-1 text-gray-600">
                Trabajamos para elevar las habilidades y competencias comunicacionales TIC en la población colombiana, construyendo un futuro digital más inclusivo y pacífico.
              </p>
            </div>
          </div>
          <!-- End Icon Block -->

...
if (is_category()) {
    ...
    $archive_type = get_taxonomy($taxonomy)->labels->singular_name;
}
?>
...
<section class="py-32">
    <div class="container">
        ...
        <?php else : ?>
            <p>No posts found in this <?php echo esc_html($archive_type); ?>.</p>
        <?php endif; ?>
    </div>
</section>

        ...
        <div class="container grid w-full grid-cols-1 gap-x-32 overflow-hidden lg:grid-cols-2">
            <div class="w-full pb-10 md:space-y-10 md:pb-0">
                <div class="space-y-4 md:max-w-[40rem]">
                    <h1 class="text-4xl font-medium lg:text-5xl">Solicita una sesión informativa</h1>
                    <div class="text-muted-foreground md:text-base lg:text-lg lg:leading-7">Programa nacional de educomunicación y alfabetización mediática con énfasis en inteligencia artificial y enfoque de paz.</div>
                </div>
                <div class="hidden md:block">
                    <div class="space-y-16 pb-20 lg:pb-0">
                        <div class="space-y-6">
                            <div class="mt-16 flex overflow-hidden">
                                <span class="relative flex shrink-0 overflow-hidden rounded-full size-11">
                                    <img class="aspect-square h-full w-full" src="https://www.shadcnblocks.com/images/block/avatar-1.webp">
                                </span>
                                <span class="relative flex shrink-0 overflow-hidden rounded-full -ml-4 size-11">
                                    <img class="aspect-square h-full w-full" src="https://www.shadcnblocks.com/images/block/avatar-3.webp">
                                </span>
                                <span class="relative flex shrink-0 overflow-hidden rounded-full -ml-4 size-11">
                                    <img class="aspect-square h-full w-full" src="https://www.shadcnblocks.com/images/block/avatar-2.webp">
                                </span>
                            </div>
                            <div class="space-y-4">
                                <p class="text-sm font-semibold">Lo que incluye el programa:</p>
                                <div class="flex items-center space-x-2.5">
                                    ...
                                    <p class="text-sm">Desarrollo de habilidades y competencias comunicacionales TIC</p>
                                </div>
                                <div class="flex items-center space-x-2.5">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-check size-5 shrink-0 text-muted-foreground">
                                        <path d="M20 6 9 17l-5-5"></path>
                                    </svg>
                                    <p class="text-sm">Alfabetización mediática e informacional para tecnologías emergentes</p>
                                </div>
                                <div class="flex items-center space-x-2.5">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-check size-5 shrink-0 text-muted-foreground">
                                        <path d="M20 6 9 17l-5-5"></path>
                                    </svg>
                                    <p class="text-sm">Contenidos digitales y alfabetizadores transmedia para la paz</p>
                                </div>
                            </div>
                        </div>
                        <div class="flex items-center space-x-12">
                            <!-- <img src="https://www.shadcnblocks.com/images/block/logos/astro.svg" alt="placeholder" class="h-6">
                            <img src="https://www.shadcnblocks.com/images/block/logos/shadcn-ui.svg" alt="placeholder" class="h-6">-->
                        </div>
                    </div>
                </div>
            </div>

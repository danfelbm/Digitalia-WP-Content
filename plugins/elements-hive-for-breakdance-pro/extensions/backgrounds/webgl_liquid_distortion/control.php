...
function controls() {
	...
	return controlSection(
		...
		[
            control(
                ...
                [
                    'type' => 'wpmedia',
                    'layout' => 'vertical',
                    'mediaOptions' => ['acceptedFileTypes' => ['0' => 'image'],
                    'multiple' => false]
                ]
            ),
            control(
            ...
            control(
                ...
                [
                    'type' => 'number',
                    'layout' => 'inline',
                    'rangeOptions' => [ 'min' => 0.1, 'max' => 2.0,'step' => 0.1,],
                ]
            ),
            control(
				'slowFade',
		...
		[
			'condition' => ['path' => 'design.elements_hive_pro.backgrounds.background_type', 'operand' => 'equals', 'value' => 'webgl_liquid_distortion'],
			'isExternal' => true,
		],
		'popout'
	);

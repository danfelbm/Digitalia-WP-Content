...
function do_the_loop($loop, $layout, $filterbar, $propertiesData, $actionData)
{
    ...
    render_static_item_at_end_of_loop_if_present($propertiesData, $loopIndex, $layout, $filterbar, $actionData);
}
...
function render_static_item_at_end_of_loop_if_present($propertiesData, $loopIndex, $layout, $filterbar, $actionData)
{
